...
<?php endif; ?>
  ...
  <div class="content"<?php print $content_attributes; ?>>
      <div id="operace_main">
	  <div id="hlavni_info_operace" class="karieraOperace">
	    <?php print render($content['field_kontakt_hlavni_nadpis']); ?>
	    <?php print render($content['field_kontakt_podnadpis']); ?>
	    <?php print render($content['body']); ?>

	    <div id="personalisti">
        <?php print render($content['field_odkazy']); ?>
          <div class="pozice1">
            <?php print render($content['field_pers1_obr']); ?>
        <span class="jmeno"><?php print render($content['field_pers1_jmeno']); ?></span>
            <?php print render($content['field_pers1_funkce']); ?>
        <span class="permail"><?php print render($content['field_pers1_email']); ?></span>
            <?php print render($content['field_pers1_telefon']); ?>
          </div>
          <div class="pozice2">
            <?php print render($content['field_pers2_obr']); ?>
        <span class="jmeno"><?php print render($content['field_pers2_jmeno']); ?></span>
            <?php print render($content['field_pers2_funkce']); ?>
        <span class="permail"><?php print render($content['field_pers2_email']); ?></span>
            <?php print render($content['field_pers2_telefon']); ?>
          </div>
          <div class="pozice3">
            <?php print render($content['field_pers3_obr']); ?>
        <span class="jmeno"><?php print render($content['field_pers3_jmeno']); ?></span>
            <?php print render($content['field_pers3_funkce']); ?>
        <span class="permail"><?php print render($content['field_pers3_email']); ?></span>
            <?php print render($content['field_pers3_telefon']); ?>
          </div>
          <div class="pozice4">
            <?php print render($content['field_pers4_obr']); ?>
        <span class="jmeno"><?php print render($content['field_pers4_jmeno']); ?></span>
            <?php print render($content['field_pers4_funkce']); ?>
        <span class="permail"><?php print render($content['field_pers4_email']); ?></span>
            <?php print render($content['field_pers4_telefon']); ?>
          </div>
	    </div>
	   ...
	   <div id="detail_operace">
	    <?php print render($content['field_seznam_pozic']); ?>
	  </div>
      </div>
  ...
  <div class="cistic"></div>
      ...
      <div id="operace_bocniobr">
	  <?php print render($content['field_sodexo']); ?>
      </div>
