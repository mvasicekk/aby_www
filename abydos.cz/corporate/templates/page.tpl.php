...
<div id="wrapper">
  ...
  <?php if(count($node->field_banner)>0){ ?>
    <a href="<?php echo $node->field_banner_odkaz['und'][0]['url']; ?>">
	    <img src="<?php echo $base_path."sites/default/files/".$node->field_banner["und"][0]["filename"]; ?>">
    </a>
  <?php }else{ ?>
    <div id="slides">
	...
	<a href="<?php print base_path(). 'cs/na_co_cekate' ; ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'corporate') . '/images/banner-web_900x300_cekate.png'; ?>"/></a>
        ...
        <a href="<?php print base_path(). 'cs/mama' ; ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'corporate') . '/images/banner-900x300_mama.jpg'; ?>"/></a>
        <a href="<?php print base_path(). 'cs/syn' ; ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'corporate') . '/images/banner-900x300_syn1.jpg'; ?>"/></a>
	<a href="<?php print base_path(). 'cs/syn2' ; ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'corporate') . '/images/banner-900x300_syn2.jpg'; ?>"/></a>
	<a href="<?php print base_path(). 'cs/kariera' ; ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'corporate') . '/images/abydos_kariera_zamestnani.jpeg'; ?>"/></a>
  <a href="<?php print base_path(). 'cs/node/187' ; ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'corporate') . '/images/banner-dualnistudium.jpg'; ?>"/></a>
	<?php } ?>

	<?php if($node->language=="ro"){ ?>

	<a href="<?php print base_path(). 'ro/aplicanti' ; ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'corporate') . '/images/banner-web_600x300-ROM.jpg'; ?>"/></a>
        <a href="<?php print base_path(). 'ro/aplicanti' ; ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'corporate') . '/images/banner-900x300_tata-ROM.jpg'; ?>"/></a>
        <a href="<?php print base_path(). 'ro/aplicanti' ; ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'corporate') . '/images/banner-900x300_mama-ROM.jpg'; ?>"/></a>
        <a href="<?php print base_path(). 'ro/aplicanti' ; ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'corporate') . '/images/banner-900x300_syn1-ROM.jpg'; ?>"/></a>
	<a href="<?php print base_path(). 'ro/aplicanti' ; ?>"><img src="<?php print base_path() . drupal_get_path('theme', 'corporate') . '/images/banner-900x300_syn2-ROM.jpg'; ?>"/></a>
