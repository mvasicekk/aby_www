  ...
  <div id="slideshow">
    <div id="slides">
      <div class="slides_container">
        <img src="<?php print base_path() . drupal_get_path('theme', 'corporate') . '/images/slide-image-0.jpg'; ?>"/>
   ...
   <?php if (theme_get_setting('footer_copyright', 'corporate') || theme_get_setting('footer_credits', 'corporate')): ?>
    <div id="footer">
      <?php if (theme_get_setting('footer_copyright', 'corporate')): ?>
        <div class="copyright"><?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?>, Abydos.</div>
      <?php endif; ?>
    </div>
   <?php endif; ?>
  </div>
