...
<!-- prvni dvojice -->
		  <tr class="popisek">
  		  ...
  		  <tr class="jmeno popisek">
		      <td>
			  <?php print render($content['field_pers1_jmeno']); ?>
		      </td>
		      <td>
			  <?php print render($content['field_pers2_jmeno']); ?>
		      </td>
		  </tr>
		  <tr class="popisek">
		      <td>
		  ...
		  <tr class="popisek">
		      <td>
			  <?php print render($content['field_pers1_email']); ?>
		      </td>
		      <td>
			  <?php print render($content['field_pers2_email']); ?>
		      </td>
		  </tr>
		  <!-- pridano 2014-02-11 -->
...
<!-- druha dvojice -->
		  <tr class="popisek">
  		  ...
  		  <tr class="jmeno popisek">
		      <td>
			  <?php print render($content['field_pers3_jmeno']); ?>
		      </td>
		      <td>
			  <?php print render($content['field_pers4_jmeno']); ?>
		      </td>
		  </tr>
		  <tr class="popisek">
		      <td>
		  ...
		  <tr class="popisek">
		      <td>
			  <?php print render($content['field_pers3_email']); ?>
		      </td>
		      <td>
			  <?php print render($content['field_pers4_email']); ?>
		      </td>
		  </tr>
		  <!-- pridano 2014-02-11 -->
         ...
         <td> <?php print render($content['field_odkazy ']); ?> </td>
